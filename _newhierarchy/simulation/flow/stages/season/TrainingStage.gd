...
func run_training_block(team: TeamData, plan: TeamSeasonPlan) -> void:
	event_log.log("training", "Starting scheduled training block.", team)
	...
	event_log.log("training", "Training block completed.", team)

func schedule_weekly_training(team: TeamData, _plan: TeamSeasonPlan) -> void:
	event_log.log("training", "Scheduling training around fixtures.", team)
	# TODO: Build weekly training schedule around matches, travel, and recovery.

func train_skills(team: TeamData) -> void:
	event_log.log("training", "Improving player skill attributes toward potential.", team)
	# TODO: Raise technical stats toward long-term potential ceilings.

func train_physical_attributes(team: TeamData) -> void:
	event_log.log("training", "Improving physical attributes toward potential.", team)
...
func develop_team_plays(team: TeamData) -> void:
	event_log.log("training", "Developing new team plays and dummy-run patterns.", team)
	# TODO: Add play concepts that overload blockers and create attacking options.

func build_connection_bonus(team: TeamData) -> void:
	event_log.log("training", "Building connection bonuses between players who train together.", team)
