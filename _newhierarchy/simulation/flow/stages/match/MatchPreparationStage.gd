...
func prepare_for_match(team: TeamData, plan: TeamSeasonPlan, opponent: TeamData) -> void:
	event_log.log("match_setup", "Preparing for match.", team)
	...
	event_log.log("match_setup", "Match preparation completed.", team)

func select_match_squad(team: TeamData, _plan: TeamSeasonPlan) -> void:
	event_log.log("match_setup", "Selecting match squad from roster.", team)
...
func select_starting_lineup(team: TeamData) -> void:
	event_log.log("match_setup", "Selecting starting lineup.", team)
	# TODO: Choose the starting six and bench order.

func configure_libero_usage(team: TeamData) -> void:
	event_log.log("match_setup", "Configuring libero usage.", team)
...
func choose_starting_rotation(team: TeamData) -> void:
	event_log.log("match_setup", "Choosing starting rotation.", team)
	# TODO: Choose the opening rotation based on strengths and matchup plan.

func choose_serving_strategy(team: TeamData, _opponent: TeamData) -> void:
	event_log.log("match_setup", "Choosing serving strategy.", team)
	# TODO: Target weak passers, zones, strong attackers, or the libero depending on plan.

func choose_receive_side_strategy(team: TeamData, _opponent: TeamData) -> void:
	event_log.log("match_setup", "Choosing initial attack structure when receiving serve.", team)
