...
func update_form(team: TeamData) -> void:
	event_log.log("form", "Updating player form state.", team)
...
func process_match_injuries(team: TeamData) -> void:
	event_log.log("injury", "Processing match injuries.", team)
